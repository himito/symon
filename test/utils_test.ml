...
let state_ = {positive = ConstraintSet.of_list [Atomic "c"];
              negative = ConstraintSet.of_list [Atomic "d"]}
...
let test_positive_part = [
  "Two element" >:: test_equal_state (ConstraintSet.of_list [Atomic "c"]) (positive_part state_)
]

(* tests for the function negative_part *)
let test_negative_part = [
  "Two elements" >:: test_equal_state (ConstraintSet.of_list [Atomic "d"]) (negative_part state_)
]
...
let test_equivalent_states = [
  ...
  "Not Equivalent" >:: test_equal false (equivalent_states state_ ({positive = ConstraintSet.of_list [Atomic "d"]; negative=ConstraintSet.of_list [Atomic "d"]}))
] 
